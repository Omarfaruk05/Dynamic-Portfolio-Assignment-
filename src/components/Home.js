        ...
        <div className="container">
          <div className="content">
            <div className="details">
              ...
              <div className="name">
                <h3>
                  {data && data?.about?.name ? data?.about?.name : "name"}
                </h3>
              </div>
              <div className="job">
                <p>
                  ...
                  From{" "}
                  <span className="purpleText">{data?.about?.address}</span>
                </p>
              </div>
              <div className="text">
              ...
              <div className="button">
                ...
                <div className="social">
                  <ul>
                    {data &&
                      data?.social_handles &&
                      data.social_handles.map((social, i) => (
                        <li key={i}>
                          <a href="#">
                            <img
                              width={23}
